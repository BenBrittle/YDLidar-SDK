...
class CYdLidar(_object):
    ...
    def setWorkMode(self, mode, addr=0x00):
...
class LaserDebug(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["cVer"] = _ydlidar.LaserDebug_cVer_set
    __swig_getmethods__["cVer"] = _ydlidar.LaserDebug_cVer_get
    if _newclass:
        cVer = _swig_property(_ydlidar.LaserDebug_cVer_get, _ydlidar.LaserDebug_cVer_set)
    __swig_setmethods__["debug2"] = _ydlidar.LaserDebug_debug2_set
    __swig_getmethods__["debug2"] = _ydlidar.LaserDebug_debug2_get
    if _newclass:
        debug2 = _swig_property(_ydlidar.LaserDebug_debug2_get, _ydlidar.LaserDebug_debug2_set)
    __swig_setmethods__["hfVer"] = _ydlidar.LaserDebug_hfVer_set
    __swig_getmethods__["hfVer"] = _ydlidar.LaserDebug_hfVer_get
    if _newclass:
        hfVer = _swig_property(_ydlidar.LaserDebug_hfVer_get, _ydlidar.LaserDebug_hfVer_set)
    __swig_setmethods__["fVer"] = _ydlidar.LaserDebug_fVer_set
    __swig_getmethods__["fVer"] = _ydlidar.LaserDebug_fVer_get
    if _newclass:
        fVer = _swig_property(_ydlidar.LaserDebug_fVer_get, _ydlidar.LaserDebug_fVer_set)
    __swig_setmethods__["month"] = _ydlidar.LaserDebug_month_set
    __swig_getmethods__["month"] = _ydlidar.LaserDebug_month_get
    if _newclass:
        month = _swig_property(_ydlidar.LaserDebug_month_get, _ydlidar.LaserDebug_month_set)
    __swig_setmethods__["day"] = _ydlidar.LaserDebug_day_set
    __swig_getmethods__["day"] = _ydlidar.LaserDebug_day_get
    if _newclass:
        day = _swig_property(_ydlidar.LaserDebug_day_get, _ydlidar.LaserDebug_day_set)
    __swig_setmethods__["year"] = _ydlidar.LaserDebug_year_set
    __swig_getmethods__["year"] = _ydlidar.LaserDebug_year_get
    if _newclass:
        year = _swig_property(_ydlidar.LaserDebug_year_get, _ydlidar.LaserDebug_year_set)
    __swig_setmethods__["numH"] = _ydlidar.LaserDebug_numH_set
    __swig_getmethods__["numH"] = _ydlidar.LaserDebug_numH_get
    if _newclass:
        numH = _swig_property(_ydlidar.LaserDebug_numH_get, _ydlidar.LaserDebug_numH_set)
    __swig_setmethods__["numL"] = _ydlidar.LaserDebug_numL_set
    __swig_getmethods__["numL"] = _ydlidar.LaserDebug_numL_get
    if _newclass:
        numL = _swig_property(_ydlidar.LaserDebug_numL_get, _ydlidar.LaserDebug_numL_set)
    __swig_setmethods__["health"] = _ydlidar.LaserDebug_health_set
    __swig_getmethods__["health"] = _ydlidar.LaserDebug_health_get
    if _newclass:
        health = _swig_property(_ydlidar.LaserDebug_health_get, _ydlidar.LaserDebug_health_set)
    __swig_setmethods__["model"] = _ydlidar.LaserDebug_model_set
    __swig_getmethods__["model"] = _ydlidar.LaserDebug_model_get
    if _newclass:
        model = _swig_property(_ydlidar.LaserDebug_model_get, _ydlidar.LaserDebug_model_set)
    __swig_setmethods__["maxIndex"] = _ydlidar.LaserDebug_maxIndex_set
    __swig_getmethods__["maxIndex"] = _ydlidar.LaserDebug_maxIndex_get
    if _newclass:
        maxIndex = _swig_property(_ydlidar.LaserDebug_maxIndex_get, _ydlidar.LaserDebug_maxIndex_set)
...
class LaserScan(_object):
    ...
    __swig_setmethods__["scanFreq"] = _ydlidar.LaserScan_scanFreq_set
    __swig_getmethods__["scanFreq"] = _ydlidar.LaserScan_scanFreq_get
    if _newclass:
        scanFreq = _swig_property(_ydlidar.LaserScan_scanFreq_get, _ydlidar.LaserScan_scanFreq_set)
    __swig_setmethods__["sampleRate"] = _ydlidar.LaserScan_sampleRate_set
    __swig_getmethods__["sampleRate"] = _ydlidar.LaserScan_sampleRate_get
    if _newclass:
        sampleRate = _swig_property(_ydlidar.LaserScan_sampleRate_get, _ydlidar.LaserScan_sampleRate_set)
    ...
    __swig_setmethods__["moduleNum"] = _ydlidar.LaserScan_moduleNum_set
    __swig_getmethods__["moduleNum"] = _ydlidar.LaserScan_moduleNum_get
    if _newclass:
        moduleNum = _swig_property(_ydlidar.LaserScan_moduleNum_get, _ydlidar.LaserScan_moduleNum_set)
    __swig_setmethods__["envFlag"] = _ydlidar.LaserScan_envFlag_set
    __swig_getmethods__["envFlag"] = _ydlidar.LaserScan_envFlag_get
    if _newclass:
        envFlag = _swig_property(_ydlidar.LaserScan_envFlag_get, _ydlidar.LaserScan_envFlag_set)
